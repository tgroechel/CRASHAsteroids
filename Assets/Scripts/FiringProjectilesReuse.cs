...
namespace Sid
{
    public class FiringProjectilesReuse : Singleton<FiringProjectilesReuse>, IMixedRealityPointerHandler, IMixedRealityInputActionHandler, IMixedRealityGestureHandler, IMixedRealityFocusHandler
    {
